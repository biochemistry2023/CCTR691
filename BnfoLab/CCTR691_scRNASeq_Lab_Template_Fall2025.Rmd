...
> number of the cells is 17ooo, t-SNE does not show separate cluster
...
```{r setup}
knitr::opts_knit$set(root.dir = "C:/Users/Izon Science/Desktop/CCTR691_scRNASeq")
```
...
```
```{r}
setwd("C:/Users/Izon Science/Desktop/CCTR691_scRNASeq")
getwd()
```
...
> 2575 samples, 19,612 number represent genes
...
whim_filtered <- subset(whim, subset = percent.mt < 21)
...
> y axis is name of the genes and x id PC
...
> we see more information and more background (noise), less PC less info
...
> less information and the elbow may not cover the data
...
> missing meaningful data (less elbow)
...
> high information and high level of the noise
